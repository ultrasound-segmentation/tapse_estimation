...
def annotate_single_point_per_video_h5(file_path, save_path, num_landmarks=3, LUT=None):
    ...
    while True:
        ...
        print(f"Frame {idx + 1}/{num_frames}")
        print(
            "Enter = select landmark, C = close, Arrow keys = navigate frames, g= change landmark (order= fw,septum,apex)"
        )
...
if __name__ == "__main__":
    ...
    reannotate_points_in_h5(
        ...
        r"d:\mmissana\data\RV_PATIENTS\RV_patients_annotated_renamed\190\P429G08O_corrected_2.h5",
        num_landmarks=3,
        LUT=LUT,
    )
